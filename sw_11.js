/* Team Bulls v9.6 — shell instantâneo, atualização silenciosa e áudio sob demanda. */
'use strict';
const CACHE_NAME='team-bulls-v9-6-fast-shell';
...
const ESSENTIAL_ASSETS=['./index.html','./recuperar.html','./manifest_10.json','./icon-192-v8-2.png','./icon-512-v8-2.png'];
