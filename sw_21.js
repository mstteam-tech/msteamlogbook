/* Team Bulls v10.4 — dietas variáveis, ciclos, planilha global e desktop responsivo. */
'use strict';
const CACHE_NAME='team-bulls-v10-4-diet-checkin-shell';
const AUDIO_CACHE_NAME='team-bulls-v9-5-security-audio';
const AUDIO_NAME_PATTERN=/^team-bulls-music-[a-z0-9-]+\.mp3$/i;
const ESSENTIAL_ASSETS=[
  './index.html','./recuperar.html','./manifest_19.json',
  './viewport_v10_2_1.js','./boot_v10.js','./app_v10_4.js','./styles_v10_4.css','./recovery_v10.js','./recovery_v10.css',
