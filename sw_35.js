/* Team Bulls v10.7 — auditoria de estabilidade, desempenho e segurança. */
'use strict';
const CACHE_NAME='team-bulls-v10-7-operations-versions-automation';
const AUDIO_CACHE_NAME='team-bulls-v9-5-security-audio';
const AUDIO_NAME_PATTERN=/^team-bulls-music-[a-z0-9-]+\.mp3$/i;
const ESSENTIAL_ASSETS=[
  './index.html','./recuperar.html','./manifest_22.json',
  './viewport_v10_2_1.js','./boot_v10.js','./config_v10_7.js','./app_v10_7_core.js','./modules/v107-core.js','./modules/v107-invites.js','./modules/v107-operations.js','./styles_v10_7.css','./recovery_v10.js','./recovery_v10.css',
