/* Team Bulls v10.10.5 — ponte de migração para instalações controladas pelo antigo sw_47.js. */
'use strict';
...
const REQUIRED_SHELL=[
  ...
  './manifest.json',
  './version.json',
  './viewport_v10_10_5.js?v=10.10.5',
  './boot_v10.js?v=10.10.5',
  './config_v10_7.js?v=10.10.5',
  './update_v10_10_5.js?v=10.10.5',
  './app_v10_10_5_core.js?v=10.10.5',
  './modules/v107-core.js?v=10.10.5',
  './modules/v107-invites.js?v=10.10.5',
  './modules/v107-operations.js?v=10.10.5',
  './interaction_v10_10_5.js?v=10.10.5',
  './styles_v10_10_5.css?v=10.10.5',
  './recuperar.html',
  './recovery_v10.js?v=10.10.5',
  './recovery_v10.css?v=10.10.5',
  './icon-192-v9-8.png',
  './icon-512-v9-8.png',
