...
for(const [name,text] of [['sw.js',sw],['sw_47.js',legacySw]]){
  assert(/const CACHE_HOTFIX='(?:workflow1|audit1|reads1|trainerworkflow1|mobilestartup1|dietautomacros1)'/.test(text),`${name} não possui cache compatível com workflow-controls ou evolução posterior.`);
