...
assert(config.includes('legacy-student-link-repair-v10_10_10.js?v=10.10.10-legacy-links2'),'Reconciliador não está carregado com cache-bust atualizado.');
...
console.log('APROVADO — reconciliação legada v2 e autorização restrita estão presentes.');
