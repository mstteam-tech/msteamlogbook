...
for(const [name,text] of [['sw.js',sw],['sw_47.js',sw47]]){
  assert(/const CACHE_HOTFIX='(?:reads1|trainerworkflow1|mobilestartup1|dietautomacros1)'/.test(text),`${name} não força shell nova para a redução de leituras ou evolução posterior.`);
