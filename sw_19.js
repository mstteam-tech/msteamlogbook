/* Team Bulls v10.2.1 — safe areas, viewport dinâmica e cache resiliente. */
'use strict';
const CACHE_NAME='team-bulls-v10-2-1-safe-area-shell';
const AUDIO_CACHE_NAME='team-bulls-v9-5-security-audio';
const AUDIO_NAME_PATTERN=/^team-bulls-music-[a-z0-9-]+\.mp3$/i;
const ESSENTIAL_ASSETS=[
  './index.html','./recuperar.html','./manifest_17.json',
  './viewport_v10_2_1.js','./boot_v10.js','./app_v10_2.js','./styles_v10_2.css','./recovery_v10.js','./recovery_v10.css',
