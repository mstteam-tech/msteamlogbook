...
(()=>{
  ...
  const trainerOnlyModules=new Set(['trainer-workspace-v10_10_9.js','trainer-diet-workspace-v10_10_11.js','trainer-inbox-payments-v10_10_12.js']);
  const moduleFile=src=>String(src||'').split('/').pop().split('?')[0];
  ...
  const roleAllowsModule=src=>!trainerOnlyModules.has(moduleFile(src))||runtimeRole()==='trainer';
