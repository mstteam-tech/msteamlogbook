/* Configuração pública Team Bulls v10.10.12 — bootstrap móvel resiliente.
...
(()=>{
  ...
  window.TeamBullsRuntimeLoader=Object.freeze({
    version:'10.10.12-startup1',ready,
    state:runtimeDetail,
