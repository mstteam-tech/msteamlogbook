/* Team Bulls v10.10.7 — interação unificada: rolagem, retrato e puxar para atualizar. */
'use strict';
(()=>{
...
/* Team Bulls v10.10.7 — navegação móvel integrada ao histórico e ao contexto interno. */
(()=>{
  'use strict';
