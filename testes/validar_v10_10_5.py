...
REQUIRED = [
    ...
    'update_v10_10_5.js', 'app_v10_10_5_core.js', 'styles_v10_10_5.css',
    'interaction_v10_10_5.js', 'viewport_v10_10_5.js', 'boot_v10.js',
    ...
    'testes/testar_orientacao_v10_10_5.js', 'testes/testar_guia_global_v10_10_5.js',
    'testes/testar_destino_exercicio_v10_10_5.js',
    'testes/testar_exclusao_registro_v10_10_5.js',
    'testes/testar_atualizacao_pwa_v10_10_5.js'
]
JS_FILES = [
    'boot_v10.js', 'config_v10_7.js', 'recovery_v10.js', 'update_v10_10_5.js',
    'app_v10_10_5_core.js', 'interaction_v10_10_5.js', 'viewport_v10_10_5.js',
    'modules/v107-core.js', 'modules/v107-invites.js', 'modules/v107-operations.js',
    'sw.js', 'sw_47.js'
]
TESTS = [
    'testar_orientacao_v10_10_5.js', 'testar_guia_global_v10_10_5.js',
    'testar_destino_exercicio_v10_10_5.js', 'testar_exclusao_registro_v10_10_5.js',
    'testar_atualizacao_pwa_v10_10_5.js'
]
...
def main():
    ...
    need(html,[
        'content="10.10.5" name="team-bulls-version"',
        'manifest.json?v=10.10.5', 'update_v10_10_5.js?v=10.10.5',
        'app_v10_10_5_core.js?v=10.10.5', 'styles_v10_10_5.css?v=10.10.5',
        'interaction_v10_10_5.js?v=10.10.5', 'viewport_v10_10_5.js?v=10.10.5',
        'modules/v107-core.js?v=10.10.5', 'VERIFICAR ATUALIZAÇÃO',
    ...
    core=(ROOT/'app_v10_10_5_core.js').read_text(encoding='utf-8')
    need(core,[
        "const APP_VERSION='10.10.5'", "const V106_RULES_FILE='firestore_26_compacto.rules'",
        "const V1010_VERSION='10.10.5'", 'function uploadReportGuidePdf',
    ...
    updater=(ROOT/'update_v10_10_5.js').read_text(encoding='utf-8')
    need(updater,[
        "const CURRENT_VERSION='10.10.5'", 'register(`./sw.js?v=${encodeURIComponent(CURRENT_VERSION)}`',
    ...
    need(worker,[
        "const APP_VERSION='10.10.5'", "const SHELL_CACHE=`team-bulls-shell-",
        "'./version.json'", "'./update_v10_10_5.js?v=10.10.5'",
    ...
    interaction=(ROOT/'interaction_v10_10_5.js').read_text(encoding='utf-8')
    need(interaction,[
    ...
    css=(ROOT/'styles_v10_10_5.css').read_text(encoding='utf-8')
    need(css,[
    ...
    if 'python testes/validar_v10_10_5.py' not in workflow:
        fail('workflow incorreto')

    sums=[]
    for path in sorted(ROOT.rglob('*')):
        if path.is_file() and path.name!='SHA256SUMS-v10.10.5.txt' and '__pycache__' not in path.parts:
            sums.append(hashlib.sha256(path.read_bytes()).hexdigest()+'  '+path.relative_to(ROOT).as_posix())
    (ROOT/'SHA256SUMS-v10.10.5.txt').write_text('\n'.join(sums)+'\n',encoding='utf-8')
    result={
    ...
    (ROOT/'testes/RESULTADO-VALIDACAO-v10.10.5.json').write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
