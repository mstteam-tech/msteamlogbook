...
VERSION = '10.10.3'
REQUIRED = [
    'index.html', 'manifest_33.json', 'sw_46.js', 'app_v10_10_3_core.js',
    'styles_v10_10_3.css', 'interaction_v10_10_3.js', 'viewport_v10_10_3.js',
    ...
    'testes/testar_orientacao_v10_10_3.js', 'testes/testar_guia_global_v10_10_3.js',
    'testes/testar_destino_exercicio_v10_10_3.js'
]
JS_FILES = [
    'boot_v10.js', 'config_v10_7.js', 'recovery_v10.js', 'app_v10_10_3_core.js',
    'interaction_v10_10_3.js', 'viewport_v10_10_3.js', 'modules/v107-core.js',
    'modules/v107-invites.js', 'modules/v107-operations.js', 'sw_46.js'
]
...
def main():
    ...
    need(html, [
        'app_v10_10_3_core.js', 'styles_v10_10_3.css', 'interaction_v10_10_3.js',
        'viewport_v10_10_3.js', 'manifest_33.json', 'id="student-global-report-guide-panel"',
    ...
    manifest = json.loads((ROOT / 'manifest_33.json').read_text(encoding='utf-8'))
    if manifest.get('start_url') != './index.html?v=10.10.3' or manifest.get('scope') != './':
    ...
    core = (ROOT / 'app_v10_10_3_core.js').read_text(encoding='utf-8')
    need(core, [
        "const APP_VERSION='10.10.3'", "navigator.serviceWorker.register('sw_46.js'",
        "const V106_RULES_FILE='firestore_26_compacto.rules'", "const V1010_VERSION='10.10.3'",
    ...
    interaction = (ROOT / 'interaction_v10_10_3.js').read_text(encoding='utf-8')
    need(interaction, [
    ...
    sw = (ROOT / 'sw_46.js').read_text(encoding='utf-8')
    need(sw, [
        "const CACHE_NAME='team-bulls-v10-10-3-runtime'", 'manifest_33.json',
        'app_v10_10_3_core.js', 'styles_v10_10_3.css'
    ], 'Service Worker')
    workflow = (ROOT / '.github/workflows/team-bulls-validate.yml').read_text(encoding='utf-8')
    if 'python testes/validar_v10_10_3.py' not in workflow:
        fail('workflow incorreto')

    sums = []
    for path in sorted(ROOT.rglob('*')):
        if path.is_file() and path.name != 'SHA256SUMS-v10.10.3.txt' and '__pycache__' not in path.parts:
            sums.append(hashlib.sha256(path.read_bytes()).hexdigest() + '  ' + path.relative_to(ROOT).as_posix())
    (ROOT / 'SHA256SUMS-v10.10.3.txt').write_text('\n'.join(sums) + '\n', encoding='utf-8')
    result = {
        ...
        'storage_rules': 'storage_5.rules', 'service_worker': 'sw_46.js',
        'manifest': 'manifest_33.json', 'keyboard_orientation_false_positive_fixed': True,
        'exercise_day_context_locked': True, 'same_screen_navigation_context_fixed': True
    }
    (ROOT / 'testes/RESULTADO-VALIDACAO-v10.10.3.json').write_text(
        json.dumps(result, ensure_ascii=False, indent=2) + '\n', encoding='utf-8'
    )
    print(
        f'APROVADO: {len(parser.ids)} IDs únicos; {len(set(parser.assets))} recursos; '
        'guia geral, destino dos exercícios, histórico móvel, cache e regras validados.'
    )
