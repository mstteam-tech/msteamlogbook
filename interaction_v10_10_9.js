/* Team Bulls v10.10.9 — interação unificada: rolagem, retrato e puxar para atualizar. */
'use strict';
(()=>{
...
/* Team Bulls v10.10.9 — navegação móvel integrada ao histórico e ao contexto interno. */
(()=>{
  'use strict';
